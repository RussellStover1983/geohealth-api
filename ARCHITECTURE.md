...
Detailed architecture documentation for the GeoHealth API. Claude Code: consult this file when you need to understand system design, but your primary working instructions are in CLAUDE.md.
